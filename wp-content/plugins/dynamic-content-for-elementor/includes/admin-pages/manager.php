...
class Manager
{
    ...
    public function warning_lazyload()
    {
        ...
        if ($lazyload) {
            $msg = esc_html__('The Elementor Expriment Lazy Load is not currently compatible with all Dynamic.ooo features, in particular it causes problems with background images inside a loop.', 'dynamic-content-for-elementor');
