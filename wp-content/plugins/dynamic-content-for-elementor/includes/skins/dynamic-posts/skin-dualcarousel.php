...
class Skin_DualCarousel extends \DynamicContentForElementor\Includes\Skins\Skin_Carousel
{
    ...
    public $depended_styles = ['dce-dynamicPosts-carousel', 'dce-dynamicPosts-dualcarousel', 'dce-swiper'];
    ...
    public function render()
    {
        ...
        $this->get_parent()->set_render_attribute('swiper-container', ['class' => ['swiper-container', 'dce-dualcarousel-gallery-thumbs']]);
