...
class Gateway
{
	...
	public function hostedRequest(array $request, bool $iframe = false, bool $modal = false): string {
		...
		if ($iframe) {
			$htmlForm = <<<HTML
<iframe id="paymentgatewayframe" name="paymentgatewayframe" frameBorder="0" seamless="seamless" style="width:100%; height:1100px;margin: 0 auto;display:block;"></iframe>
HTML;
