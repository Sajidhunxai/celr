...
?>
    <div class="vintage-filter-container">
        <div class="vintage-filter-form">
            <button class="vintage-button" data-vintage="">All</button>
            <?php
    ...
    <script>
        (function($) {
            $(document).ready(function() {
                // Store the default HTML content
                // var defaultHtml = '<div class="year-filter">';
                // defaultHtml += '<h2 class="product-title">' + '<?php echo $product->get_name(); ?>' + '</h2>';
                // defaultHtml += '<img src="' + '<?php echo $product->get_image_id() ? wp_get_attachment_image_src($product->get_image_id(), "full")[0] : wc_placeholder_img_src(); ?>' + '" />';
                // defaultHtml += '</div>';
